...
class Wisconsin(NodeClassificationDataset):
    def __init__(self, split):
        assert split <= 9, "Wisconsin provides 10 default splits indexed 0...9"
        self.split = split
        super().__init__(name="Wisconsin")
        self.epochs = 200
    ...
    def load_graph(self) -> dgl.DGLGraph:
        ...
        pyg = WebKB(root=root, name="Wisconsin")[0]
        self.pyg = pyg
