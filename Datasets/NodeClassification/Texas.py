...
class Texas(NodeClassificationDataset):
    def __init__(self, split):
        assert split <= 9, "Texas provides 10 default splits indexed 0...9"
        self.split = split
        super().__init__(name="Texas")
        self.epochs = 200

    def load_graph(self) -> dgl.DGLGraph:
        """
        Loads the Texas graph and ensures:
        ...
        pyg = WebKB(root=root, name="Texas")[0]
        self.pyg = pyg
