...
from Datasets.NodeClassification.Wisconsin import Wisconsin as WisconsinNodeClassification
from Datasets.NodeClassification.Chameleon import Chameleon as ChameleonNodeClassification
from Datasets.NodeClassification.Squirrel import Squirrel as SquirrelNodeClassification
from Datasets.NodeClassification.Texas import Texas as TexasNodeClassification
from Datasets.NodeClassification.Cornell import Cornell as CornellNodeClassification
from Datasets.NodeClassification.Pubmed import Pubmed as PubmedNodeClassification
...
NODE_CLASSIFICATION_DATASETS = {
    "Cornell": CornellNodeClassification,
    "Texas": TexasNodeClassification,
    "Wisconsin": WisconsinNodeClassification,
    "Chameleon": ChameleonNodeClassification,
    "Squirrel": SquirrelNodeClassification,
    "Pubmed": PubmedNodeClassification,
