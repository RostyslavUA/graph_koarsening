...
from GraphSummarizers.Coarsener.NodeClassification.NodeClassificationGKSummarizer import NodeClassificationGKSummarizer
...
GRAPH_SUMMARIZERS = {
    ...
    "NodeClassificationGKSummarizer": NodeClassificationGKSummarizer,
